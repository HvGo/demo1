...
// NOTE: This page is archived - Featured Listings API integration was abandoned
// The IDX Broker API /clients/featured endpoint does not return listing data
...
export default function ArchivedPage() {
  return <div>This page has been archived</div>;
}
