      ...
      <div className='overflow-hidden relative'>
        ...
        <div className='container max-w-8xl mx-auto px-5 2xl:px-0 pt-12 md:pt-[28rem] pb-16 md:pb-40 flex flex-col'>
          <div className='relative text-white dark:text-white text-center md:text-center z-10'>
            <p className='text-inherit text-xm font-medium'>Vende tu Casa Inteligentemente</p>
            ...
            <div className='flex flex-col xs:flex-row justify-center md:justify-center gap-4 mb-8'>
              <a href='#cma-form' className='px-8 py-4 rounded-full text-base font-semibold hover:cursor-pointer flex items-center gap-2 bg-teal-500 text-white shadow-lg shadow-black/25 ring-1 ring-white/10 hover:bg-teal-600 transition-colors'>
                Obtén tu CMA
              </a>
